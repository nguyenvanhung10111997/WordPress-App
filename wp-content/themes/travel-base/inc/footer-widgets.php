...
class Travel_Base_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'travel_base';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'travel-base' ), $i ),
...
// Initialize.
$travel_base_footer_widgets = new Travel_Base_Footer_Widgets();
